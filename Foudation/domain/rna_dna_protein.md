...
Enzyme RNA polymerase bám vào DNA tại vị trí gene cần đọc.
DNA mở xoắn cục bộ, lộ ra 1 mạch làm khuôn (template strand).
RNA polymerase đọc mạch khuôn, tổng hợp mRNA bổ sung (A-U, T-A, G-C, C-G).
mRNA hoàn chỉnh rời nhân tế bào, đi ra tế bào chất.
...
Câu 1. DNA có cấu trúc dạng gì? A. Chuỗi đơn thẳng B. Chuỗi xoắn kép C. Hình cầu D. Chuỗi xoắn ba

Câu 2. Trong DNA, Adenine (A) bắt cặp với base nào? A. Guanine (G) B. Cytosine (C) C. Thymine (T) D. Uracil (U)

Câu 3. Đặc điểm nào KHÔNG đúng khi mô tả RNA so với DNA? A. RNA là mạch đơn B. RNA dùng đường ribose C. RNA có base Thymine D. RNA có base Uracil

Câu 4. Enzyme nào chịu trách nhiệm tổng hợp mRNA từ DNA? A. DNA polymerase B. RNA polymerase C. Ribosome D. tRNA synthetase

Câu 5. mRNA có vai trò gì? A. Lưu trữ thông tin di truyền vĩnh viễn B. Mang bản sao thông tin từ nhân ra tế bào chất C. Tạo năng lượng cho tế bào D. Vận chuyển amino acid
...
Tại sao là bộ 3, không phải bộ 1 hay bộ 2? Bài toán tổ hợp đơn giản: 4 loại base, cần mã hóa ít nhất 20 amino acid.
...
✅ ĐÁP ÁN
Đáp án Quiz 1 (5 câu)
B — Chuỗi xoắn kép (double helix).
C — Thymine (T); A-T bắt cặp bằng 2 liên kết hydro.
C — RNA không có Thymine, mà thay bằng Uracil (U).
B — RNA polymerase.
B — mRNA mang bản sao thông tin di truyền từ nhân ra tế bào chất để tổng hợp protein.
Đáp án Quiz 2 (10 câu)
3 nucleotide (bộ ba — triplet).
64 codon (4³ = 64) — 4 loại base, mỗi codon gồm 3 vị trí, mỗi vị trí có 4 lựa chọn độc lập.
AUG — mã hóa Methionine (Met), đồng thời là tín hiệu khởi đầu dịch mã.
UAA, UAG, UGA.
tRNA mang amino acid tương ứng đến ribosome; anticodon của nó khớp bổ sung với codon trên mRNA, đảm bảo amino acid gắn đúng vị trí, đúng thứ tự.
Ribosome gồm rRNA (ribosomal RNA) kết hợp protein, tạo thành 2 tiểu đơn vị lớn và nhỏ.
Đúng thứ tự: Khởi đầu (Initiation) → Kéo dài (Elongation) → Kết thúc (Termination).
Vì bộ mã di truyền có 64 codon nhưng chỉ cần mã hóa 20 amino acid + tín hiệu dừng → nhiều codon đồng nghĩa (synonymous codons) cùng mã hóa 1 amino acid (ví dụ Leucine có 6 codon khác nhau).
Dòng chảy: DNA → RNA → Protein (phiên mã rồi dịch mã).
DNA → Protein: SUY RA ĐƯỢC (xác định, một chiều). Protein → DNA: MƠ HỒ, không suy ngược chính xác được. → Xem giải thích chi tiết bên dưới.
